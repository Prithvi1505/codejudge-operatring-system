"""
JOBS list for Zone Job-Scheduler.

PCB fields:
- job_id  → Process ID
- priority → Scheduling information (lower number = higher priority)

The remaining fields (zone, arrival_time, burst_time) are simulation-only metadata
used by the scheduling algorithms and are not PCB fields.
"""
